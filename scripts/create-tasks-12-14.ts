...
// 12月12日 JST 9:00 = 12月12日 UTC 0:00 = 2025-12-12T00:00:00Z
// 12月12日 JST 17:00 = 12月12日 UTC 8:00 = 2025-12-12T08:00:00Z
const SCHEDULES = {
  '2025-12-12_09:00': new Date('2025-12-12T00:00:00Z').getTime(),
  '2025-12-12_17:00': new Date('2025-12-12T08:00:00Z').getTime(),
  '2025-12-13_09:00': new Date('2025-12-13T00:00:00Z').getTime(),
  '2025-12-13_17:00': new Date('2025-12-13T08:00:00Z').getTime(),
  '2025-12-14_09:00': new Date('2025-12-14T00:00:00Z').getTime(),
  '2025-12-14_17:00': new Date('2025-12-14T08:00:00Z').getTime(),
  '2025-12-15_09:00': new Date('2025-12-15T00:00:00Z').getTime(),
  '2025-12-15_17:00': new Date('2025-12-15T08:00:00Z').getTime(),
};
...
const EXECUTION_PLAN = [
  // 12月12日
  { date: '2025-12-12', time: '09:00', group: 'G1', preset: 'P23' },
  { date: '2025-12-12', time: '09:00', group: 'G2', preset: 'P25' },
  { date: '2025-12-12', time: '09:00', group: 'G3', preset: 'P19' },
  { date: '2025-12-12', time: '17:00', group: 'G1', preset: 'P15' },
  { date: '2025-12-12', time: '17:00', group: 'G2', preset: 'P14' },
  { date: '2025-12-12', time: '17:00', group: 'G3', preset: 'P27' },
  // 12月13日
  { date: '2025-12-13', time: '09:00', group: 'G1', preset: 'P26' },
  { date: '2025-12-13', time: '09:00', group: 'G2', preset: 'P24' },
  { date: '2025-12-13', time: '09:00', group: 'G3', preset: 'P25' },
  { date: '2025-12-13', time: '17:00', group: 'G1', preset: 'P19' },
  { date: '2025-12-13', time: '17:00', group: 'G2', preset: 'P23' },
  { date: '2025-12-13', time: '17:00', group: 'G3', preset: 'P15' },
  // 12月14日
  { date: '2025-12-14', time: '09:00', group: 'G1', preset: 'P25' },
  { date: '2025-12-14', time: '09:00', group: 'G2', preset: 'P27' },
  { date: '2025-12-14', time: '09:00', group: 'G3', preset: 'P24' },
  { date: '2025-12-14', time: '17:00', group: 'G1', preset: 'P14' },
  { date: '2025-12-14', time: '17:00', group: 'G2', preset: 'P19' },
  { date: '2025-12-14', time: '17:00', group: 'G3', preset: 'P23' },
  // 12月15日
  { date: '2025-12-15', time: '09:00', group: 'G1', preset: 'P24' },
  { date: '2025-12-15', time: '09:00', group: 'G2', preset: 'P26' },
  { date: '2025-12-15', time: '09:00', group: 'G3', preset: 'P14' },
  { date: '2025-12-15', time: '17:00', group: 'G1', preset: 'P27' },
  { date: '2025-12-15', time: '17:00', group: 'G2', preset: 'P15' },
  { date: '2025-12-15', time: '17:00', group: 'G3', preset: 'P26' },
];

// グループのコンテナ数を取得
function getGroupContainerCount(groupId: string): number {
  const count = db.prepare('SELECT COUNT(*) as count FROM container_group_members WHERE group_id = ?').get(groupId) as { count: number };
  return count.count;
}
...
function main() {
  ...
  for (const plan of EXECUTION_PLAN) {
    ...
    for (const containerId of containers.task1) {
      createTask(presetId, containerId, scheduledAt, QUEUES.TASK1, groupId);
      totalTasks++;
    }
    for (const containerId of containers.task2) {
      createTask(presetId, containerId, scheduledAt, QUEUES.TASK2, groupId);
      totalTasks++;
    }
    for (const containerId of containers.task3) {
      createTask(presetId, containerId, scheduledAt, QUEUES.TASK3, groupId);
      totalTasks++;
    }
    
    console.log(`✓ ${plan.date} ${plan.time} ${plan.group} ${plan.preset}: ${containers.task1.length + containers.task2.length + containers.task3.length}件登録`);
  }
